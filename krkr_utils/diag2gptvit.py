...
def filter_and_sample(data, k, n, cv, random_number):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sd', '--scene_dir', type=str, default="", help="scene文本路径")
    ...
    parser.add_argument('-vd', '--voice_dir', type=str, default="", help="wav文件路径")
    ...
    data = read_file_to_list(args.scene_dir)
    print(type(data[0]))
